...
def plan(payload):
    ...
    return {
        ...
        "requirements": [
            ...
            "Seed standard fields may support listed comparables but never replace private target evidence",
            "secondary repetition does not upgrade a claim to supported",
            "all final external numbers and company facts must exist in the claim ledger",
        ...
        "seed_finance_policy": (
            {
                "allowed_scope": [
                    ...
                    "industry",
                    "listed_comparables",
                    "public_financial_clues",
                ],
                "general_document_scope": [
                    "company",
                    "investor",
                    "counterparty",
                    "regulator",
            ...
            if skill == "private-market-project-evaluation"
            else None
        ),
    }
