...
def main():
    ...
    facts_hash_before = hashlib.sha256(facts.read_bytes()).hexdigest()
    gates = []
    ...
    manifest = {
        ...
        "facts_sha256_before": facts_hash_before,
        "facts_sha256_after": hashlib.sha256(facts.read_bytes()).hexdigest(),
        "gates": gates,
        "products": products,
        "warnings": warnings,
    }
