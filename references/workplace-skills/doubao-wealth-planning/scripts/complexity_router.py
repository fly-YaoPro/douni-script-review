...
TIER_CONFIG = {
    ...
    "wealth-planning": {
        "direct": {
            ...
            "slots": ["direct_answer", "hard_gates", "formula_or_priority", "immediate_actions", "missing_inputs", "professional_boundary"],
        },
        "brief": {
            "target_chars": 2600,
            "hard_max_chars": 4200,
            "hard_max_output_tokens": 2400,
            "slots": ["baseline", "hard_gates", "priority", "scenario", "actions", "unknowns", "professional_boundary"],
        },
        "full": {
            "target_chars": 6000,
            "hard_max_chars": 9000,
            "hard_max_output_tokens": 5200,
            "slots": ["household_snapshot", "hard_gates", "goals", "cashflow", "risk_capacity", "scenarios", "allocation_boundary", "actions", "assumptions", "unknowns", "artifact_index"],
        },
    },
